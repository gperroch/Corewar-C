...
/*   Updated: 2016/05/11 15:42:56 by tpaulmye         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
** zum beispiel :
** lld 	%2864434397, r1 == 0290 aabb ccdd 01	DIR 4o, REG 1o
** lld 	2864434397,	 r1 == 02d0 ccdd 01			IND 2o, REG 1o
** pas de modulo IDX_MOD au parametre
*/
...
int				op_lld(t_core *c, t_proc *process, int op_addr)
{
	...
	if ((c->options & OPT_V) && (c->verbose_level & 32))
		...
		"param[%d] => r%d\n",
		c->ncycles, "\033[32m", "OP_LLD", "\033[0m", process->owner->number,
		op_addr, param, reg);
	return (0);
}
